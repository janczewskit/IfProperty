...
namespace IfProperty.Tests.Expressions
{
    ...
    public class LessThanAttributeTest
    {
        ...
        private class Model
        {
            ...
            [Is(LessThan, Property = nameof(Value1))]
        ...
        private class ModelWithPassOnNull
        {
            ...
            [Is(LessThan, Property = nameof(Value1), PassOnNull = true)]
            public int? Value2 { get; set; }
        }
        ...
        private class ModelOrEqual
        {
            ...
            [Is(LessThanOrEqualTo, Property = nameof(Value1))]
            public int? Value2 { get; set; }
        }
        ...
        private class ModelOrEqualThanWithPassOnNull
        {
            ...
            [Is(LessThanOrEqualTo, Property = nameof(Value1), PassOnNull = true)]
            public int? Value2 { get; set; }
        }
    }
}
